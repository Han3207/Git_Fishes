...
(My GitHub Repository)[https://github.com/Han3207/Git_Fishes]
...
## This is because, the GitHub is only cloning my repository that I have saved on my computer. Thus, if I delete the data on the computer then on the GitHUb it will also be gone. It is mainly used so that that other people can look at the R coding in this case and edit/ help each other. 
...
# Making the echo = FALSE will make the 'answer1' code block no longer display the code along with the results.
```
...
tablesum <- as.data.frame(rbind(c('18', '17', '-6.2, 8.3', '0.3', '41', '0.8'), c('25', '26', '-8.7, 6.0', '-0.4', '25', '0.7'), c('27', '29', '-4.8, 1.6','-1', '174', '0.3'), c('40', '35', '0.83, 9.90', '2', '124', '0.02'), c('26', '20', '-0.55, 13.04', '2,42', '0.07'), c('24', '27', '-5.9, 1.6', '-1', '118', '0.3')))
dimnames(tablesum) <- list(species = c("ambon", "chromis", "acantho", "humbug", "lemon", "whitedams"), 
                           party = c("mean of CO2 activity", "mean of control activity", "95% Confidence intervals", "t-statistic", "df", "p-value"))
